...
job_flow_overrides = {
	...
	"LogUri": "s3://mybkt7-22/emr-logs-yml/",
	...
	"Instances": {
		...
		"Ec2SubnetId": "subnet-06a5bb602c9e743d4",
...
SPARK_STEPS_EXTRACTION = [
	{
		...
		"HadoopJarStep": {
			...
			"Args": [
				"s3://mybkt7-22/scripts/ingest.sh",
			],
		},
	},
]
...
SPARK_STEPS_TRANSFORMATION = [
	{
		...
		"HadoopJarStep": {
			...
			"Args": ["spark-submit",
			"s3://mybkt7-22/scripts/transform_redfin_data.py",
			],
		},
	},
]
...
default_args = {
	...
	'email': ['eng.mohamed.kemany@gmail.com'],
