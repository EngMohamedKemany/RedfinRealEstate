...
def transform_date():
    raw_data_s3_bucket = "s3://mybkt7-22/store-raw-data-yml/city_market_tracker.tsv000.gz"
    transform_data_s3_bucket = "s3://mybkt7-22/redfin-transform-zone-yml/redfin_data.parquet"
